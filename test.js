...
check('hex letter-first', 'mov ax, ABCDh',              'B8 CD AB');
check('hex lowercase',   'mov al, ffh',                 'B0 FF');
check('hex in data',     'dw 0BEEFh, BEEFh',            'EF BE EF BE');
check('reg not hex',     'mov ah, 0Ah',                 'B4 0A');
checkError('db reg name', 'db ah', 'undefined symbol');
checkError('hex-like label', 'deadh: nop', 'number literal');
